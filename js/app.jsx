...
const allPubs = [
  ...
  { authors:'Ferhat Erata, Chuanqi Xu, Ruzica Piskac, Jakub Szefer', title:'Quantum Circuit Reconstruction from Power Side-Channel Attacks on Quantum Computer Controllers', venue:'TCHES', year:2024, pdf:'#', bib:'#', themes:['security'] },
  ...
  { authors:'Stephen Miner, Yoshiki Takashima, Simeng Han, Sam Kouteili, Ferhat Erata, Ruzica Piskac, Scott J Shapiro', title:'Scheherazade: Evaluating Chain-of-Thought Math Reasoning in LLMs with Chain-of-Problems', venue:'NeurIPS ER Workshop', year2025:, pdf'https://arxiv.org/pdf/2410.00151':, bib:'#', themes:['mlai'] },
];
