...
const allPubs = [
  ...
  { authors:'Raoul van Doren, Timos Antonopoulos, Ruzica Piskac', title:'Efficient and Verifiable Proof Logging for MaxSAT Solving', venue:'ASE', year:2025, pdf:'https://www.cs.yale.edu/homes/antonopoulos-timos/ASE-2025.pdf', bib:'https://dblp.org/rec/conf/kbse/DorenAP25.html?view=bibtex', themes:['mlai', 'verification'] },
  { authors:'John C. Kolesar, Shan Ali, Timos Antonopoulos, Ruzica Piskac', title:'Coinductive Proofs of Regular Expression Equivalence in Zero Knowledge', venue:'OOPSLA', year:2025, pdf:'https://www.cs.yale.edu/homes/antonopoulos-timos/OOPSLA-2025.pdf', bib:'https://dblp.org/rec/journals/pacmpl/KolesarAAP25.html?view=bibtex', themes:['privacy'] },
  ...
  { authors:'Daniel Luick, John C. Kolesar, Timos Antonopoulos, William R. Harris, James Parker, Ruzica Piskac, Eran Tromer, Xiao Wang, Ning Luo', title:'ZKSMT: A VM for Proving SMT Theorems in Zero Knowledge', venue:'USENIX Security', year:2024, pdf:'https://www.cs.yale.edu/homes/antonopoulos-timos/USENIX-Security-2024.pdf', bib:'https://dblp.org/rec/conf/uss/LuickKAHPPT0L24.html?view=bibtex', themes:['privacy'] },
