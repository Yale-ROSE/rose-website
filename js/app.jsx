...
const allPubs = [
  ...
  { authors:'Ning Luo, Timos Antonopoulos, William R. Harris, Ruzica Piskac, Eran Tromer, Xiao Wang', title:'Proving UNSAT in Zero Knowledge', venue:'CCS', year:2022, pdf:'https://www.cs.yale.edu/homes/antonopoulos-timos/CCS-2022.pdf', bib:'#', themes:['privacy', 'verification'] },
  ...
  { authors:'Yichao Cheng, Ning Luo, Jingxuan Zhang, Timos Antonopoulos, Ruzica Piskac, Qiao Xiang', title:'Looking for the Maximum Independent Set: A New Perspective on the Stable Path Problem', venue:'INFOCOM', year:2021, pdf:'https://www.cs.yale.edu/homes/antonopoulos-timos/INFOCOM-2021.pdf', bib:'#', themes:['networks'] },
  { authors:'Tachio Terauchi, Timos Antonopoulos', title:'Bucketing and Information Flow Analysis for Provable Timing Attack Mitigation', venue:'JCS 28(6)', year:2020, pdf:'https://www.cs.yale.edu/homes/antonopoulos-timos/JCS-2020.pdf', bib:'#', themes:['security'] },
  { authors:'Ton Chanh Le, Timos Antonopoulos, Parisa Fathololumi, Eric Koskinen, ThanhVu Nguyen', title:'DynamiTe: Dynamic Termination and Non-termination Proofs', venue:'OOPSLA', year:2020, pdf:'https://www.cs.yale.edu/homes/antonopoulos-timos/OOPSLA-2020.pdf', bib:'#', themes:['verification', 'mlai'] },
  ...
  { authors:'Samuel Judson, Ning Luo, Timos Antonopoulos, Ruzica Piskac', title:'Privacy Preserving CTL Model Checking through Oblivious Graph Algorithms', venue:'WPES', year:2020, pdf:'https://www.cs.yale.edu/homes/antonopoulos-timos/WPES-2020.pdf', bib:'#', themes: ['privacy', 'verification'] },
  ...
  { authors:'Timos Antonopoulos, Eric Koskinen, Ton Chanh Le', title:'Specification and Inference of Trace Refinement Relations', venue:'OOPSLA', year:2019, pdf:'https://www.cs.yale.edu/homes/antonopoulos-timos/OOPSLA-2019.pdf', bib:'#', themes:['verification', 'mlai'] },
  ...
  { authors:'Timos Antonopoulos, Tachio Terauchi', title:'Games for Security under Adaptive Adversaries', venue:'CSF', year:2019, pdf:'https://www.cs.yale.edu/homes/antonopoulos-timos/CSF-2019.pdf', bib:'#', themes:['security'] },
  { authors:'Tachio Terauchi, Timos Antonopoulos', title:'A Formal Analysis of Timing Channel Security via Bucketing', venue:'POST', year:2019, pdf:'https://www.cs.yale.edu/homes/antonopoulos-timos/POST-2019.pdf', bib:'#', themes:['security'] },
  ...
  { authors:'Timos Antonopoulos, Paul Gazzillo, Michael Hicks, Eric Koskinen, Tachio Terauchi, Shiyi Wei', title:'Decomposition Instead of Self-Composition for Proving the Absence of Timing Channels', venue:'PLDI', year:2017, pdf:'https://www.cs.yale.edu/homes/antonopoulos-timos/PLDI-2017.pdf', bib:'#', themes:['security'] },
  ...
  { authors:'Ferhat Erata, Chuanqi Xu, Ruzica Piskac, Jakub Szefer', title:'Quantum Circuit Reconstruction from Power Side-Channel Attacks on Quantum Computer Controllers', venue:'TCHES 2024(2)', year:2024, pdf:'#', bib:'#', themes:['security'] },
  ...
  { authors:'Xi Zheng, Aloysius K. Mok, Ruzica Piskac, Yong Jae Lee, Bhaskar Krishnamachari, Dakai Zhu, Oleg Sokolsky, Insup Lee', title:'Testing Learning-Enabled Cyber-Physical Systems with Large-Language Models: A Formal Approach', venue:'FSE Companion', year:2024, pdf:'#', bib:'#', themes:['mlai', 'verification'] },
  { authors:'Haoran Ding, Zhaoguo Wang, Yicun Yang, Dexin Zhang, Zhenglin Xu, Haibo Chen, Ruzica Piskac, Jinyang Li', title:'Proving Query Equivalence Using Linear Integer Arithmetic', venue:'SIGMOD', year:2023, pdf:'#', bib:'#', themes:['verification'] },
  { authors:'Ferhat Erata, Eren Yildiz, Arda Goknil, Kasim Sinan Yildirim, Jakub Szefer, Ruzica Piskac, Gökçin Sezgin', title:'ETAP: Energy-aware Timing Analysis of Intermittent Programs', venue:'TECS 22(2)', year:2023, pdf:'#', bib:'#', themes:['security'] },
  { authors:'Ferhat Erata, Ruzica Piskac, Víctor Mateu, Jakub Szefer', title:'Towards Automated Detection of Single-Trace Side-Channel Vulnerabilities in Constant-Time Cryptographic Code', venue:'EuroS&P', year:2023, pdf:'#', bib:'#', themes:['security'] },
  { authors:'Katrine Bjørner, Samuel Judson, Filip Cano, Drew Goldman, Nicholas Shoemaker, Ruzica Piskac, Bettina Könighofer', title:'Formal XAI via Syntax-Guided Synthesis', venue:'AISoLA', year:2023, pdf:'#', bib:'#', themes:['law', 'synthesis'] },
  { authors:'John C. Kolesar, Ruzica Piskac, William T. Hallahan', title:'Checking equivalence in a non-strict language', venue:'OOPSLA', year:2022, pdf:'#', bib:'#', themes:['verification'] },
  ...
  { authors:'Wonhyuk Choi, Bernd Finkbeiner, Ruzica Piskac, Mark Santolucito', title:'Can reactive synthesis and syntax-guided synthesis be friends?', venue:'PLDI', year:2022, pdf:'#', bib:'#', themes:['synthesis'] },
  ...
  { authors:'Jialu Zhang, Ruzica Piskac, Ennan Zhai, Tianyin Xu', title:'Static detection of silent misconfigurations with deep interaction analysis', venue:'OOPSLA', year:2021, pdf:'#', bib:'#', themes:['networks', 'verification'] },
  { authors:'Eric Hayden Campbell, William T. Hallahan, Priya Srikumar, Carmelo Cascone, Jed Liu, Vignesh Ramamurthy, Hossein Hojjat, Ruzica Piskac, Robert Soulé, Nate Foster', title:'Avenir: Managing Data Plane Diversity with Control Plane Synthesis', venue:'NSDI', year:2021, pdf:'#', bib:'#', themes:['networks', 'synthesis'] },
  { authors:'Julien Lepiller, Ruzica Piskac, Martin Schäf, Mark Santolucito', title:'Analyzing Infrastructure as Code to Prevent Intra-update Sniping Vulnerabilities', venue:'TACAS', year:2021, pdf:'#', bib:'#', themes:['security', 'verification'] },
  { authors:'William T. Hallahan, Ennan Zhai, Ruzica Piskac', title:'Automated repair by example for firewalls', venue:'FMSD 56(1)', year:2020, pdf:'#', bib:'#', themes:['networks', 'synthesis'] },
  { authors:'Kairo Morton, William T. Hallahan, Elven Shum, Ruzica Piskac, Mark Santolucito', title:'Grammar Filtering for Syntax-Guided Synthesis', venue:'AAAI', year:2020, pdf:'#', bib:'#', themes:['mlai', 'synthesis'] },
  { authors:'Ruzica Piskac', title:'Efficient Automated Reasoning About Sets and Multisets with Cardinality Constraints', venue:'IJCAR', year:2020, pdf:'#', bib:'#', themes:['verification'] },
  { authors:'Ennan Zhai, Ang Chen, Ruzica Piskac, Mahesh Balakrishnan, Bingchuan Tian, Bo Song, Haoliang Zhang', title:'Check before You Change: Preventing Correlated Failures in Service Updates', venue:'NSDI', year:2020, pdf:'#', bib:'#', themes:['networks'] },
  { authors:'Nicholas Shoemaker, Ruzica Piskac, Mark Santolucito', title:'Towards checkpoint placement for dynamic memory allocation in intermittent computing', venue:'TAPAS', year:2020, pdf:'#', bib:'#', themes:['verification'] },
  { authors:'Mark Santolucito, Ruzica Piskac', title:'Formal Methods and Computing Identity-based Mentorship for Early Stage Researchers', venue:'SIGCSE', year:2020, pdf:'#', bib:'#', themes:['education'] },
  { authors:'Maxwell Levatich, Nikolaj S. Bjørner, Ruzica Piskac, Sharon Shoham', title:'Solving LIA* Using Approximations', venue:'VMCAI', year:2020, pdf:'#', bib:'#', themes:['verification'] },
  { authors:'Bernd Finkbeiner, Felix Klein, Ruzica Piskac, Mark Santolucito', title:'Temporal Stream Logic: Synthesis Beyond the Bools', venue:'CAV', year:2019, pdf:'#', bib:'#', themes:['synthesis'] },
  { authors:'Mark Santolucito, William T. Hallahan, Ruzica Piskac', title:'Live Programming By Example', venue:'CHI Extended Abstracts', year:2019, pdf:'#', bib:'#', themes:['synthesis'] },
  { authors:'William T. Hallahan, Anton Xue, Ruzica Piskac', title:'G2Q: Haskell constraint solving', venue:'Haskell@ICFP', year:2019, pdf:'#', bib:'#', themes:['verification'] },
  { authors:'Bernd Finkbeiner, Felix Klein, Ruzica Piskac, Mark Santolucito', title:'Synthesizing functional reactive programs', venue:'Haskell@ICFP', year:2019, pdf:'#', bib:'#', themes:['synthesis'] },
  { authors:'William T. Hallahan, Anton Xue, Maxwell Troy Bland, Ranjit Jhala, Ruzica Piskac', title:'Lazy counterfactual symbolic execution', venue:'PLDI', year:2019, pdf:'#', bib:'#', themes:['verification'] },
  { authors:'Mark Santolucito, Kate Rogers, Aedan Lombardo, Ruzica Piskac', title:'Programming-by-example for audio: synthesizing digital signal processing programs', venue:'FARM@ICFP', year:2018, pdf:'#', bib:'#', themes:['synthesis'] },
  { authors:'Mark Santolucito, Drew Goldman, Allyson Weseley, Ruzica Piskac', title:'Programming by Example: Efficient, but Not "Helpful"', venue:'PLATEAU@SPLASH', year:2018, pdf:'#', bib:'#', themes:['synthesis'] },
  { authors:'Ruzica Piskac', title:'New Applications of Software Synthesis: Verification of Configuration Files and Firewall Repair', venue:'SAS', year:2018, pdf:'#', bib:'#', themes:['synthesis'] },
  { authors:'Mark Santolucito, Ennan Zhai, Rahul Dhodapkar, Aaron Shim, Ruzica Piskac', title:'Synthesizing configuration file specifications with association rule learning', venue:'OOPSLA', year:2017, pdf:'#', bib:'#', themes:['synthesis', 'mlai'] },
  { authors:'Ennan Zhai, Ruzica Piskac, Ronghui Gu, Xun Lao, Xi Wang', title:'An auditing language for preventing correlated failures in the cloud', venue:'OOPSLA', year:2017, pdf:'#', bib:'#', themes:['networks'] },
  { authors:'Bernd Finkbeiner, Felix Klein, Ruzica Piskac, Mark Santolucito', title:'Vehicle Platooning Simulations with Functional Reactive Programming', venue:'SCAV@CPSWeek', year:2017, pdf:'#', bib:'#', themes:['synthesis'] },
  { authors:'William T. Hallahan, Ennan Zhai, Ruzica Piskac', title:'Automated repair by example for firewalls', venue:'FMCAD', year:2017, pdf:'#', bib:'#', themes:['networks', 'synthesis'] },
  { authors:'Mark Santolucito, Ennan Zhai, Ruzica Piskac', title:'Probabilistic Automated Language Learning for Configuration Files', venue:'CAV', year:2016, pdf:'#', bib:'#', themes:['mlai', 'synthesis'] },
  { authors:'Alex Reinking, Ruzica Piskac', title:'A Type-Directed Approach to Program Repair', venue:'CAV', year:2015, pdf:'#', bib:'#', themes:['synthesis'] },
  { authors:'Sumit Gulwani, Mikaël Mayer, Filip Niksic, Ruzica Piskac', title:'StriSynth: Synthesis for Live Programming', venue:'ICSE', year:2015, pdf:'#', bib:'#', themes:['synthesis'] },
  { authors:'Tihomir Gvero, Viktor Kuncak, Ivan Kuraj, Ruzica Piskac', title:'InSynth: A System for Code Completion using Types and Weights', venue:'Software Engineering & Management', year:2015, pdf:'#', bib:'#', themes:['synthesis'] },
