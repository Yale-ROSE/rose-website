...
const allPubs = [
  ...
  { authors:'Katrine Bjørner, Samuel Judson, Filip Cano, Drew Goldman, Nicholas Shoemaker, Ruzica Piskac, Bettina Könighofer', title:'Formal XAI via Syntax-Guided Synthesis', venue:'AISoLA', year:2023, pdf:'#', bib:'https://dblp.org/rec/conf/aisola/BjornerJCGSPK23.html?view=bibtex', themes:['law', 'synthesis'] },
  ...
  { authors:'Jialu Zhang, De Li, John Charles Kolesar, Hanyuan Shi, Ruzica Piskac', title:'Automated Feedback Generation for Competition-Level Code', venue:'ASE', year:2022, pdf:'#', bib:'https://dblp.org/rec/conf/kbse/ZhangLKSP22.html?view=bibtex', themes:['mlai'] },
  ...
  { authors:'Eric Hayden Campbell, William T. Hallahan, Priya Srikumar, Carmelo Cascone, Jed Liu, Vignesh Ramamurthy, Hossein Hojjat, Ruzica Piskac, Robert Soulé, Nate Foster', title:'Avenir: Managing Data Plane Diversity with Control Plane Synthesis', venue:'NSDI', year:2021, pdf:'#', bib:'https://dblp.org/rec/conf/nsdi/CampbellHSCLRHPSF21.html?view=bibtex', themes:['networks', 'synthesis'] },
  ...
  { authors:'Nicholas Shoemaker, Ruzica Piskac, Mark Santolucito', title:'Towards checkpoint placement for dynamic memory allocation in intermittent computing', venue:'TAPAS', year:2020, pdf:'#', bib:'https://dblp.org/rec/conf/tapas/ShoemakerPS20.html?view=bibtex', themes:['verification'] },
  ...
  { authors:'Bernd Finkbeiner, Felix Klein, Ruzica Piskac, Mark Santolucito', title:'Temporal Stream Logic: Synthesis Beyond the Bools', venue:'CAV', year:2019, pdf:'#', bib:'https://dblp.org/rec/conf/cav/FinkbeinerKPS19.html?view=bibtex', themes:['synthesis'] },
  ...
  { authors:'Bernd Finkbeiner, Felix Klein, Ruzica Piskac, Mark Santolucito', title:'Synthesizing functional reactive programs', venue:'Haskell@ICFP', year:2019, pdf:'#', bib:'https://dblp.org/rec/conf/haskell/FinkbeinerKPS19.html?view=bibtex', themes:['synthesis'] },
  ...
  { authors:'Bernd Finkbeiner, Felix Klein, Ruzica Piskac, Mark Santolucito', title:'Vehicle Platooning Simulations with Functional Reactive Programming', venue:'SCAV@CPSWeek', year:2017, pdf:'#', bib:'https://dblp.org/rec/conf/cpsweek/FinkbeinerKPS17.html?view=bibtex', themes:['synthesis'] },
